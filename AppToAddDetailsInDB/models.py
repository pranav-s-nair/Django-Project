...
class Students(models.Model):
    ...
    rollnumber = models.CharField(db_column='rollNumber', max_length=45, blank=True,
    ...
    studentscol = models.CharField(db_column='Studentscol', max_length=45, blank=True,
                                   null=True)  # Field name made lowercase.
...
class PopulationCount(models.Model):
    ...
    country = models.CharField(db_column='country', max_length=45, blank=True,
                               null=True)  # Field name made lowercase.
    year = models.CharField(db_column='year', max_length=45, blank=True,
                            null=True)  # Field name made lowercase. Field renamed because it was a Python reserved word.
    population = models.CharField(db_column='population', max_length=45, blank=True,
                                  null=True)  # Field name made lowercase.
